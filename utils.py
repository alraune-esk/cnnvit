...
def visualize_cam(mask, img, alpha=1.0):
    ...
    #     for index, pixel in enumerate(item):
    #         for a, c in enumerate(pixel):
    #             blue = b[count][index][a]
    #             red = r[count][index][a]
    #             green = g[count][index][a]
    #             if red + green - blue > 0:
    #                 b[count][index][a] = 0
    #                 g[count][index][a] = 0
    #                 r[count][index][a] = 0
    #                 img[count][index][a] = 0
    #                 img[count+1][index][a] = 0
    #                 img[count+2][index][a] = 0
    max_y = 0
    min_y = 999
    max_x = 0
    min_x = 999
