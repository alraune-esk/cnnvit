...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        # self.CNN = CNN(in_features=dim, hidden_features=mlp_hidden_dim, act_layer=act_layer, drop=drop)
        # print(dim)
    ...
    def forward(self, x):
        ...
        # x = x + self.drop_path(self.CNN(self.norm2(x)))
